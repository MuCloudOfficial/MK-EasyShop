...
class Main : JavaPlugin() {
    ...
    companion object{
        ...
        fun createAsyncTimerTsk(delay: Long, period: Long, tsk: Runnable): BukkitTask {
            return Bukkit.getScheduler().runTaskTimerAsynchronously(instance, tsk, delay, period)
        }

        fun createAsyncTsk(tsk: Runnable): BukkitTask{
            return Bukkit.getScheduler().runTaskAsynchronously(instance, tsk)
        }
    }
